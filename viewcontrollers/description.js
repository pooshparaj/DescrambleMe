...
module.exports.controller = function(app){
	app.get('/description',function(req,res){
		getWordDetails("cqAFg509aw", res, "dog");
	});
};
...
{		var http = require("http");
		...
		var request = http.request(options, function(response){
			...
			response.on('end', function() {	
				...
				var collection = {'KeyWord':keyWord,'Audio':Audio,'Definition':Definition,'Usage':Usage,'Phrase':Phrase,'Synonyms':Synonyms, 'Anagrams':Anagrams,'Images':image}
